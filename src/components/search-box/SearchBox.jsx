...
const SearchBox = () => {
  ...
  return <Box position="relative" flex="1 1 0" maxWidth="670px" mx="auto" {...{
    ref: parentRef
      ...
      <TextField variant="outlined" placeholder="Qidirish..." fullWidth onChange={hanldeSearch} InputProps={{
      sx: {
        height: 44,
        borderRadius: 300,
        paddingRight: 0,
...
const categories = ["Barcha kategoriyalar", "Car", "Clothes", "Electronics", "Laptop", "Desktop", "Camera", "Toys"];
