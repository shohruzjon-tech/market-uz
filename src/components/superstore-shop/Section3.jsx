...
const Section3 = ({
  ...
  return <CategorySectionCreator icon={<Category color="primary" />} title="Ommabop kategoriyalar" seeMoreLink="#">
      <Carousel totalSlides={5} visibleSlides={visibleSlides}>
        {categoryList.map((item, ind) => <Link href={item.categoryUrl} key={ind}>
            <a>
              <BazarCard sx={{
            p: "1rem"
          }} elevation={0}>
